  ...
  return (
    <div style={{ minHeight: '100vh', background: '#000000' }}>
      ...
      <header style={{
        ...
        <div style={{ maxWidth: '1280px', margin: '0 auto', display: 'flex', alignItems: 'center', height: '60px', justifyContent: 'space-between' }}>
        ...
        <div style={{
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', gap: '10px', marginBottom: '4px' }}>
              <span style={{ fontSize: '22px' }}>{isBuyBetter ? '🏠' : '🔑'}</span>
              <h2 style={{
                fontSize: '20px',
                fontWeight: 700,
            ...
            <p style={{ fontSize: '14px', color: 'var(--text-secondary)', letterSpacing: '-0.01em' }}>
              {isBuyBetter
          ...
          {result.breakevenYear && (
            <div style={{
              ...
              <div style={{ fontSize: '26px', fontWeight: 700, letterSpacing: '-0.03em', color: 'var(--text-primary)' }}>
          ...
          <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
              {[
                ...
                <div key={card.label} style={{
                  ...
                  <div style={{ fontSize: '30px', fontWeight: 700, letterSpacing: '-0.03em', color: card.color, lineHeight: 1, marginBottom: '6px' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '14px' }}>
              {[
                ...
                <div key={card.label} style={{
                  ...
                  <div style={{ fontSize: '30px', fontWeight: 700, letterSpacing: '-0.03em', color: card.better ? 'var(--green-400)' : 'var(--text-secondary)', lineHeight: 1, marginBottom: '6px' }}>
            ...
            <div style={{
              ...
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginBottom: '20px' }}>
                <h3 style={{ fontSize: '18px', fontWeight: 600, letterSpacing: '-0.02em' }}>
              ...
              <ResponsiveContainer width="100%" height={300}>
                <AreaChart data={chartData} margin={{ top: 5, right: 10, left: 10, bottom: 5 }}>
                  ...
                  <XAxis dataKey="year" tick={{ fill: 'var(--text-muted)', fontSize: 11 }} tickLine={false} axisLine={false} tickFormatter={(v) => `Yr ${v}`} />
                  <YAxis tick={{ fill: 'var(--text-muted)', fontSize: 11 }} tickLine={false} axisLine={false} tickFormatter={(v) => formatCurrency(v)} width={70} />
                  <Tooltip content={<CustomTooltip />} />
                  <Legend wrapperStyle={{ fontSize: '12px', color: 'var(--text-secondary)', paddingTop: '16px' }} iconType="circle" iconSize={8} />
                  {activeTab === 'networth' ? (
                    <>
            ...
            <div style={{
              ...
              <h3 style={{ fontSize: '18px', fontWeight: 600, letterSpacing: '-0.02em', marginBottom: '18px' }}>
